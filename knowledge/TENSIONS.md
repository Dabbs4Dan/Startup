...
**Last updated:** 2026-04-27 (post-Rob Snyder podcast — Rob-pole reinforced)
...
**Pole 2 — Sell to learn / Go where the work is** ([Rob Snyder — Path to PMF](knowledge/articles/rob-snyder-path-to-pmf.md), [Rob Snyder — Where to Find Ideas podcast](knowledge/youtube/rob-snyder-where-to-find-ideas.md)): **Customer interviews are insufficient — and arrogant.** Despite "doing a bunch of customer research, interviews, discovery" → founders still build things people don't want. The mechanism (citing Parker Ence): interviews are **social transactions** — humans are generous, encouraging, less discerning when no money is at stake. The mechanism (Rob's stronger version in the podcast): *"It is the height of arrogance to say I can figure out what people want from 30-minute open-ended conversations."* Plus: discovery interviews are *"in the uncanny valley between LARP and productive"* — they feel useful (the interviewee thanks you, validates) without producing real signal. **The alternative:** if you don't have a hypothesis of pull, *go where your customers are* — work alongside them for a week. (Cited examples: HBS grad → EMT for 6 months; greenhouse designer → bought a greenhouse.) Then, write the hypothesis using the **Pull Framework** (project + unavoidable + options + limits), and run **5-call sprints** until 4-of-5 pull and you know why the 5th didn't. **Strength:** real-money signal can't lie; *"it would be weird if they didn't buy"* test is a sharp gut-check. **Weakness:** still assumes you have *some* starting hypothesis — works less well for the founder with zero hypothesis (though "go become the customer" addresses this partially).
