...
## Founder must personally do the conviction work — can't outsource

**Sources (3 publishers):**
- [Diana Hu — How To Build A Company With AI](knowledge/youtube/diana-hu-ai-native-company.md) (yc) — *"You cannot outsource conviction on AI"*
- [Sam Altman — Startup Idea + Great Wave](knowledge/youtube/sam-altman-startup-idea-and-the-great-wave.md) (yc) — passionate conviction in a specific idea is load-bearing
- [Techstars — Customer Development](knowledge/articles/techstars-customer-development.md) (techstars) — *"get out of the building"* / no internal theorizing substitute
- [Techstars — EQ for Entrepreneurs](knowledge/articles/techstars-eq-for-entrepreneurs.md) (techstars) — only 10–15% have high self-awareness despite 95% believing they do; the founder's blind spots are the leverage point
- [Rob Snyder — Path to PMF](knowledge/articles/rob-snyder-path-to-pmf.md) (personal-blog) — *"I was the product (in Gsheets) until $100k ARR. I onboarded the first 300 customers 1:1."*

**Synthesis:** Three publishers agree from different angles: the founder personally has to do the work — meet customers, use the tools, sit with the problem, **and sell + deliver manually until you understand the business**. Diana names it: *can't outsource AI conviction*. Altman frames the bar: *passionate belief in a specific idea is what carries you through the long middle*. Techstars Customer Dev makes it operational: *get out of the building, do empathy interviews yourself*. Techstars EQ explains why founders skip this (overestimated self-awareness). Rob Snyder makes it *radically physical*: the founder IS the product in V1, IS the salesperson, IS the delivery. No customer login until $1M ARR. 1:1 onboarding for the first 300 customers. **Conviction comes from contact AND commerce, not analysis.**

**Implication for the founder:** Time spent in sales calls + customer delivery + with the tools is the primary input to good judgment. Delegating this is delegating the actual work of being a founder. When you don't know what to do, the answer is almost always: *take one more sales call; deliver to one more customer manually; sit with the problem one more week.* **You can't think your way to conviction — you have to sell your way to it.**

---

## Outcome measurement (not motion) is the discipline

**Sources (3 publishers):**
- [Diana Hu — How To Build A Company With AI](knowledge/youtube/diana-hu-ai-native-company.md) (yc) — queryable org, dashboards across every function, evals as agent gating
- [YC Lightcone — 7 Most Powerful Moats](knowledge/youtube/yc-lightcone-seven-powers-ai-moats.md) (yc) — evals as the flywheel; 80/20 → 99% reliability is the moat work
- [Techstars — KPIs + OKRs](knowledge/articles/techstars-kpis-and-okrs.md) (techstars) — *"motion vs progress"*; activities aren't outcomes; weekly variance is the engine
- [Techstars — Position Your Product](knowledge/articles/techstars-position-your-product.md) (techstars) — pitch reactions ARE the data; *"if no one is reacting, you haven't nailed the business"*
- [Rob Snyder — Path to PMF](knowledge/articles/rob-snyder-path-to-pmf.md) (personal-blog) — **retention is the marker of PMF, not (just) growth**; "hell yes" pre- AND post-sale

**Synthesis:** Three publishers warn against the same trap from different domains: confusing **activity for progress**. Diana's queryable org and eval discipline = measurement infrastructure for AI products. Lightcone's eval-as-moat = same principle, externally visible. Techstars OKRs = the generic version: 2–3 KPIs, weekly variance. Techstars Position adds: pitch reactions ARE the data. Rob Snyder *names the right metric for pre-PMF specifically*: **retention** (people at "equilibrium 2" who can't go back) is the marker, not growth. He's also explicit that pre-sale "hell yes" + post-sale "hell yes" are both required — growth alone deceives. **The discipline is the same: define expected outcomes, measure actual, learn from variance.** Pre-PMF, the variance check is "are they pulling, are they renewing?" — not pipeline volume.

**Implication for the founder:** Pair every "ship" with a "what would success look like, and how would we know?" If you can't answer it, the first is gambling. Pre-PMF, **track retention before growth** — Rob's most-loaded warning. Adopt the weekly OKR review cadence early — lightweight at small scale, catches drift before it compounds. **Don't celebrate tickets-closed; celebrate needles-moved.**
